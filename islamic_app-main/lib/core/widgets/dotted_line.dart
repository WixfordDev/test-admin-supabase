...
class DottedLine extends StatelessWidget {
  ...
  Widget _buildDash(bool isHorizontal, Color color) {
    return Container(
      decoration: BoxDecoration(
        color: color,
        borderRadius: BorderRadiusDirectional.circular(dashRadius),
      ),
  ...
  Widget _buildDashGap(bool isHorizontal, Color color) {
    return Container(
      decoration: BoxDecoration(
        color: color,
        borderRadius: BorderRadiusDirectional.circular(dashGapRadius),
      ),
  ...
  Color _calculateGradientColor(
    ...
    var diffAlpha = (endColor.a - startColor.a);
    ...
    return startColor.withValues(
      alpha: (startColor.a + amountOfChangeInAlphaPerItem * index),
      red: (startColor.r + amountOfChangeInRedPerItem * index),
      green: (startColor.g + amountOfChangeInGreenPerItem * index),
      blue: (startColor.b + amountOfChangeInBluePerItem * index),
    );
  }
}
