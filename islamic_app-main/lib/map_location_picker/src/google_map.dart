...
class _GoogleMapLocationPickerState extends State<GoogleMapLocationPicker> {
            ...
            children: [
              ...
              GoogleMap(
                ...
                onTap: (LatLng position) {
                  _updateLocationLatLng(position);
                },
              ...
              Column(
                ...
                children: [
                  if (!widget.hideSearchBar)
                    ...
                    //     // context.pop();
                    //     context.pop();
                    //       // Navigator.popUntil(context, ModalRoute.withName('/locationPicker'));
                    //       // Navigator.popUntil(context, ModalRoute.withName('/addBillboard'));
                    //   },
                    // ),
                    Container(
                          ...
                          ListTile(
                            ...
                            trailing: ImageView(
                              ...
                              onTap: () {
                                ...
                                context.pop(_geocodingResult);
                              },
                              imagePath: Icons.check_rounded,
  ...
  Future<void> _updateLocationLatLng(LatLng position) async {
  ...
  Future<void> onOptionTap(GeocodingResult element) async {
    _initialPosition = LatLng(
